...
// registered tools (README's "Tools (38 total)" header and its three
...
const READ_TOOLS = [
  ...
  "get_combat_state", "get_chat_log", "search_journal", "get_journal_entry", "get_users",
...
test("registers exactly the documented 38 tools", () => {
